...
const jobContiner = document.querySelectorAll(".jobContiner");
...
window.addEventListener("scroll", () => {
  ...
  jobContiner[0].style.backgroundPositionY = `${offsetY * 0.5}px`;
  jobContiner[1].style.backgroundPositionY = `${-offsetY * 0.5}px`;
  ...
  phone.style.transform = `translateX(calc(600vh - ${offsetY * 0.96}px))`;
